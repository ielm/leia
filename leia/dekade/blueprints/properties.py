...
class DEKADEAPIPropertiesBlueprint(Blueprint):
    ...
    def __init__(self, app: DEKADE):
        ...
        self.add_url_rule(
            "/api/knowledge/properties/children/<property>",
            endpoint=None,
            view_func=self.knowledge_properties_children,
            methods=["GET"],
        )
        self.add_url_rule(
            "/api/knowledge/properties/filter/<substring>",
            endpoint=None,
            view_func=self.knowledge_properties_filter,
            methods=["GET"],
        )
        self.add_url_rule(
            "/api/knowledge/properties/property/<property>",
            endpoint=None,
            view_func=self.knowledge_properties_property,
            methods=["GET"],
        )
