...
export async function apiKnowledgeOntologyWriteAddFiller(concept, property, facet, filler, meta) {
    try {
        const response = await axios.post("/api/knowledge/ontology/concept/" + concept + "/filler/add", {
            property: property,
            facet: facet,
            filler: filler,
            meta: meta
...
export async function apiKnowledgeOntologyWriteRemoveFiller(concept, property, facet, filler, type) {
    try {
        const response = await axios.post("/api/knowledge/ontology/concept/" + concept + "/filler/remove", {
            property: property,
            facet: facet,
            filler: filler,
            type: type
...
export async function apiKnowledgeOntologyWriteUnblockFiller(concept, property, facet, filler, type) {
    try {
        const response = await axios.post("/api/knowledge/ontology/concept/" + concept + "/filler/unblock", {
            property: property,
            facet: facet,
            filler: filler,
            type: type
