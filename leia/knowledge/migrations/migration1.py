...
class PropInstancesToAOsMigration(object):
    ...
    def __init__(self, knowledge_root: str):
        ...
        self.properties = set(map(lambda p: p[0:-5], os.listdir("%s/properties" % knowledge_root)))
                ...
                for k, v in semstruc.items():
                    if k.startswith("REFSEM"):
                        ...
                        if refsem in self.properties:
                            ...
                            semstruc[k] = {
                                "ABSTRACT-OBJECT": migrated_refsem
                            }
                    ...
                    k_unindexed = k if len(optional_index) == 0 else k.replace(optional_index[0], "")
                    ...
                    if k_unindexed in self.properties:
                        ...
                        k_indexed = "ABSTRACT-OBJECT%s" % "" if len(optional_index) == 0 else optional_index[0]
