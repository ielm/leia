...
if __name__ == "__main__":
    ...
    agent.memory.ontology.concept("MOVE").add_parent(
        agent.memory.ontology.concept("EVENT")
    )
    effector = agent.memory.ontology.concept("EFFECTOR")
    effector_type = agent.memory.ontology.concept(
        "SIMPLE-HAND-AND-ARM-EFFECTOR"
    ).add_parent(effector)
