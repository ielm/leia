...
if __name__ == "__main__":
    ...
    print("The SIZE of the THEME of %s is: %s." % (xmr2.name, xmr2.root().value("THEME").value("SIZE")))
    print("The SIZE of the THEME of %s is: %s." % (xmr3.name, xmr3.root().value("THEME").value("SIZE")))