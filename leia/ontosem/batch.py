...
if __name__ == "__main__":
    ...
    MONGODB_CLOUD_SHARED_URL = "mongodb://leia-admin:bgdWkMhfKSHeXAKc@ec2-3-83-217-159.compute-1.amazonaws.com"
    MONGO_URL = os.environ["MONGO_URL"] if "MONGO_URL" in os.environ else MONGODB_CLOUD_SHARED_URL
    MONGO_DATABASE = os.environ["MONGO_DATABASE"] if "MONGO_DATABASE" in os.environ else "leia-analyses"
    MONGO_COLLECTION = os.environ["MONGO_COLLECTION"] if "MONGO_COLLECTION" in os.environ else "analyses"
