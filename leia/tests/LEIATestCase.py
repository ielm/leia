...
class LEIATestCase(TestCase):
    ...
    def mockSense(
        ...
        synstruc: list = None,
        semstruc: Union[str, dict] = None,
        tmrhead: str = None,
        meaning_procedures: List[List[str]] = None,
        output_syntax: Union[str, List[str]] = None,
        example_deps: List[Tuple[str, str, str]] = None,
        example_bindings: List[str] = None,
        types: List[str] = None,
    ...
    def mockWord(
        ...
        coref = list(
            map(
                lambda c: c if isinstance(c, WordCoreference) else WordCoreference(*c),
                coref,
            )
        )
