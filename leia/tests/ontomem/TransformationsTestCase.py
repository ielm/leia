...
from leia.ontomem.transformations import (
    Transformation,
...
class TestTransformationExecutable(TransformationExecutable):
    pass
...
class TransformationTestCase(TestCase):
    ...
    def test_index(self):
        ...
        self.assertEqual(
            [
                SynStruc(
                    contents=[{"type": "dependency", "deptype": "nsubjpass", "var": 0}]
                ),
                SynStruc(
                    contents=[
                        {"type": "constituency", "contype": "NP", "children": []},
        ...
        self.assertEqual(
            TestTransformationExecutable.__name__, trans.executable.__name__
        )
