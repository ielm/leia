from ontosem.syntax.results import LispParser, SenseMap, SynMap, Syntax, Word, WordCoreference
...
class SyntaxTestCase(TestCase):
    ...
    @patch("ontosem.syntax.results.Syntax.parse_lisp_results")
    ...
    @patch("ontosem.syntax.results.Word.parse_lisp_results")
    @patch("ontosem.syntax.results.SynMap.parse_lisp_results")
    @patch("ontosem.syntax.results.Sense.parse_lisp")
